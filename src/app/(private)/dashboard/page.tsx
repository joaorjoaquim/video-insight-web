    ...
    const extractMetadata = async () => {
      ...
      try {
        ...
        if (metadata) {
          ...
          setMetadataError("Could not fetch preview for this platform, but you can still submit your video.");
        }
      } catch (error) {
        setVideoMetadata({
          platform: detectPlatform(watchedUrl),
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f8f6fc] to-white dark:from-zinc-950 dark:to-zinc-900">
      ...
      <main className="max-w-5xl mx-auto px-4 pt-8 pb-16">
        ...
        <section className="flex flex-col items-center text-center mb-10">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-zinc-900 dark:text-zinc-100">Turn Any Video into Instant Insights</h1>
          <p className="text-zinc-600 dark:text-zinc-300 mb-6 max-w-2xl">Extract knowledge, summaries, and key takeaways from any video in minutes.</p>
          <form className="w-full max-w-2xl flex flex-col gap-2 bg-white dark:bg-zinc-900 shadow-lg rounded-lg p-3 mb-4 border border-zinc-200 dark:border-zinc-800">
            <label htmlFor="video-url" className="text-left text-sm font-medium text-zinc-700 dark:text-zinc-200 mb-1">
              Paste your URL. <span className="text-zinc-500">We support YouTube, Vimeo, Twitter, and many other platforms.</span>
            </label>
            ...
            <div className="w-full max-w-2xl mx-auto mt-4">
              <div className="bg-white dark:bg-zinc-900 rounded-lg p-4 border border-zinc-200 dark:border-zinc-800">
                <div className="flex items-center justify-center">
                  ...
                  <span className="ml-3 text-zinc-600 dark:text-zinc-300">Loading video metadata...</span>
                </div>
              </div>
            </div>
          )}
          ...
          {errors.url && <span className="text-red-500 text-sm">Please enter a valid video URL.</span>}
          
        </section>

        {/* Submissions List */}
        <section className="mb-12">
          <h2 className="text-xl font-semibold mb-2 text-zinc-900 dark:text-zinc-100">Your Submissions</h2>
          <p className="text-zinc-500 mb-4">Track the progress of your video processing jobs</p>
          <SubmissionList />
        </section>
