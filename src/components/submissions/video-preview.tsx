...
const platformIcons: Record<string, React.ReactNode> = {
  ...
  vimeo: (
    <svg className="w-5 h-5 text-blue-500" viewBox="0 0 24 24">
      <path
        fill="currentColor"
        d="M22.23 7.82c-.09 2-1.48 4.74-4.18 8.13-2.79 3.53-5.14 5.3-7.06 5.3-1.19 0-2.2-1.1-3.02-3.29-.55-2.01-1.1-4.02-1.65-6.03-.61-2.21-1.26-3.32-1.95-3.32-.15 0-.67.31-1.56.93l-.94-1.21c.98-.86 1.94-1.72 2.91-2.58 1.31-1.13 2.29-1.73 2.95-1.8 1.55-.16 2.5.91 2.85 3.21.39 2.56.66 4.15.8 4.77.45 2.04.95 3.06 1.5 3.06.42 0 1.05-.67 1.89-2.01.84-1.34 1.29-2.36 1.36-3.07.12-1.16-.34-1.74-1.36-1.74-.48 0-.98.11-1.5.33 1-3.29 2.91-4.88 5.74-4.77 2.09.07 3.07 1.42 2.94 4.05z"
      />
    </svg>
  ),
  twitter: (
