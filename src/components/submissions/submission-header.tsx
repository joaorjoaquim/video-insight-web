      ...
      <CardContent className="p-6">
        <div className="flex flex-col md:flex-row gap-6 items-start">
          <div className="flex-shrink-0">
            <div className="aspect-square w-24 h-24 rounded-lg bg-zinc-100 dark:bg-zinc-800 flex items-center justify-center overflow-hidden">
              {thumbnail ? (
                <img
                  src={thumbnail}
                  alt={title}
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-3 mb-1">
              ...
              <Badge
                variant="secondary"
                className="ml-auto bg-green-100 text-green-700 dark:bg-green-900 dark:text-green-200"
              >
                {status}
              </Badge>
            </div>
              ...
              {steps.map((step, i) => (
                ...
                >
                  <HugeiconsIcon
                    ...
                    className={`text-base ${
                      step.done ? "text-green-500" : "text-zinc-400"
                    }`}
                  />
                  <span
                    className={
